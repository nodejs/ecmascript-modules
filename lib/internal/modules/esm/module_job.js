...
const { ModuleWrap, DynamicModuleWrap } = internalBinding('module_wrap');
...
class ModuleJob {
  ...
  constructor(loader, url, moduleProvider, isMain) {
    ...
    // This is a Promise<module>, which will be copied
    ...
    const link = async () => {
      ...
      assert(this.module instanceof ModuleWrap || this.module instanceof DynamicModuleWrap);
